...
class PrimaryCapsule(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, dim_caps, kernel_size, stride=1, padding=1):
...
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=16):
        ...
        self.fc2 = nn.Sequential(nn.Conv2d(in_planes, in_planes // ratio, 1, bias=False),
                                nn.ReLU(),
                                nn.Conv2d(in_planes // ratio, in_planes, 1, bias=False))
